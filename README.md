...
```bash
git clone https://github.com/mobassirrehman/The-Book-Haven-Client.git
...
For the backend server, visit: [Book Haven Server Repository](https://github.com/mobassirrehman/the-book-haven-server)
